...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'konnect:index/user:User';
     ...
     */
    public readonly preferredName!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: UserArgs | UserState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["preferredName"] = state ? state.preferredName : undefined;
        } else {
            ...
            resourceInputs["preferredName"] = args ? args.preferredName : undefined;
...
export interface UserState {
     ...
     * **(Optional, String)** The preferred name of the user.
     */
    preferredName?: pulumi.Input<string>;
}
