...
func NewProvider(ctx *pulumi.Context,
	...
	if args.Pat == nil {
		return nil, errors.New("invalid value for required argument 'Pat'")
	}
...
func (o ProviderOutput) Pat() pulumi.StringOutput {
	return o.ApplyT(func(v *Provider) pulumi.StringOutput { return v.Pat }).(pulumi.StringOutput)
}
