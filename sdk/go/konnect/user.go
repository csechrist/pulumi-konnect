...
func NewUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.RegisterResource("konnect:index/user:User", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUser(ctx *pulumi.Context,
	...
	var resource User
	err := ctx.ReadResource("konnect:index/user:User", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o UserOutput) FullName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *User) pulumi.StringPtrOutput { return v.FullName }).(pulumi.StringPtrOutput)
}

// **(Optional, String)** The preferred name of the user.
func (o UserOutput) PreferredName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *User) pulumi.StringPtrOutput { return v.PreferredName }).(pulumi.StringPtrOutput)
}
