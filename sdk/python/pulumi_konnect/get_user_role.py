...
def get_user_role(entity_type_display_name: Optional[str] = None,
    ...
    :param str entity_type_display_name: **(Optional, String)** The filter string to apply to the display name of the entity type. Must be `Control Planes` or `Services`. Uses equality.
    :param str role_display_name: **(Optional, String)** The filter string to apply to the display name of the role. Uses equality.
    :param str search_entity_type_display_name: **(Optional, String)** The search string to apply to the display name of the entity type, like `Control Planes` or `Services`. Uses contains.
