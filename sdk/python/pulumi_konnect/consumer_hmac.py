...
__all__ = ['ConsumerHMACArgs', 'ConsumerHMAC']

@pulumi.input_type
class ConsumerHMACArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] secret: **(Optional/Computed, String)** The secret value.  If left out, a secret will be generated for you.
        """
...
class _ConsumerHMACState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] consumer_id: **(Required, String)** The id of the consumer.
        :param pulumi.Input[str] control_plane_id: **(Required, String)** The id of the control plane.
        :param pulumi.Input[str] hmac_id: **(String)** Id of the consumer HMAC alone
        :param pulumi.Input[str] secret: **(Optional/Computed, String)** The secret value.  If left out, a secret will be generated for you.
        :param pulumi.Input[str] username: **(Required, String)** The username value.
        """
        ...
        if control_plane_id is not None:
            pulumi.set(__self__, "control_plane_id", control_plane_id)
        if hmac_id is not None:
            pulumi.set(__self__, "hmac_id", hmac_id)
        if secret is not None:
            pulumi.set(__self__, "secret", secret)
    ...
    @property
    @pulumi.getter(name="hmacId")
    def hmac_id(self) -> Optional[pulumi.Input[str]]:
        """
        **(String)** Id of the consumer HMAC alone
        """
        return pulumi.get(self, "hmac_id")

    @hmac_id.setter
    def hmac_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "hmac_id", value)
...
class ConsumerHMAC(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        consumer = konnect.get_consumer(control_plane_id=control_plane.id,
            search_username="Bob")
        example = konnect.ConsumerHMAC("example",
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ConsumerHMACArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ConsumerHMACArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ConsumerHMACArgs.__new__(ConsumerHMACArgs)
            ...
            __props__.__dict__["hmac_id"] = None
        super(ConsumerHMAC, __self__).__init__(
            'konnect:index/consumerHMAC:ConsumerHMAC',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            hmac_id: Optional[pulumi.Input[str]] = None,
            secret: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'ConsumerHMAC':
        """
        ...
        __props__ = _ConsumerHMACState.__new__(_ConsumerHMACState)

        __props__.__dict__["consumer_id"] = consumer_id
        __props__.__dict__["control_plane_id"] = control_plane_id
        __props__.__dict__["hmac_id"] = hmac_id
        __props__.__dict__["secret"] = secret
        __props__.__dict__["username"] = username
        return ConsumerHMAC(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="hmacId")
    def hmac_id(self) -> pulumi.Output[str]:
        """
        **(String)** Id of the consumer HMAC alone
        """
        return pulumi.get(self, "hmac_id")
