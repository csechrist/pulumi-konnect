...
class GetConsumerResult:
    ...
    """
    def __init__(__self__, consumer_id=None, control_plane_id=None, custom_id=None, id=None, search_custom_id=None, search_username=None, username=None):
...
def get_consumer(control_plane_id: Optional[str] = None,
    ...
    example = konnect.get_consumer(control_plane_id=control_plane.id,
        search_username="Bob")
    ```


    :param str control_plane_id: **(Required, String)** The id of the control plane containing consumer
...
def get_consumer_output(control_plane_id: Optional[pulumi.Input[str]] = None,
                        custom_id: Optional[pulumi.Input[Optional[str]]] = None,
