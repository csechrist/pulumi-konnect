...
class UserRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] entity_type_display_name: **(Required, ForceNew, String)** The display name of the entity type, like `Control Planes` or `Services`.
        :param pulumi.Input[str] role_display_name: **(Required, ForceNew, String)** The display name of the role.
        :param pulumi.Input[str] user_id: **(Required, ForceNew, String)** The id of the user assigned the role
        """
