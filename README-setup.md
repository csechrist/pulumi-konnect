...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `konnect` with the `NAME` of your provider.
...
- binary: pulumi-resource-konnect
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-konnect/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-konnect_darwin_amd64_v1
│   └── pulumi-resource-konnect
├── pulumi-konnect_darwin_arm64
│   └── pulumi-resource-konnect
├── pulumi-konnect_linux_amd64_v1
│   └── pulumi-resource-konnect
├── pulumi-konnect_linux_arm64
│   └── pulumi-resource-konnect
├── pulumi-konnect_windows_amd64_v1
│   └── pulumi-resource-konnect.exe
└── pulumi-konnect_windows_arm64
    └── pulumi-resource-konnect.exe
```
